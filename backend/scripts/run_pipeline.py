...
def main():
    ...
    steps = [
        ("Generating Sample Data", "scripts/generate_sample_data.py"),
        ("Preprocessing Data", "scripts/data_preprocessing.py"),
        ("Training Models", "scripts/model_training.py"),
        ("Evaluating & Visualizing", "scripts/evaluation.py"),
    ]
